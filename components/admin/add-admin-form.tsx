...
import { AddAdminProfile, addAdminProfileSchema } from "@/schemas/admin.schema";
...
export function AddAdminForm() {
    ...
    const { mutate, isPending } = usePostData("/create/admin");
    const router = useRouter();
    const [previewUrl, setPreviewUrl] = useState<string | null>(null);

    const form = useForm<AddAdminProfile>({
        resolver: zodResolver(addAdminProfileSchema),
        defaultValues: {
            name: "",
            mobile: "",
            email: "",
    ...
    const onSubmit = (data: AddAdminProfile) => {
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>
                                                <RequiredLabel label="Admin Name" />
                                            </FormLabel>
                                            <FormControl>
                                                <Input
